<template>
  <div>
    ...
    <Card title="常州市督查巡查统计" :padding="0" shadow class="qytj_table">
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {title: '未巡查企业数（家）', key: 'zhuti',},
          {title: '巡查1次企业数（家）', key: 'zhuti',},
          {title: '巡查2次及以上企业数（家）', key: 'zhuti',},
          {title: '巡查主体总数（家）', key: 'zhuti',},
          {title: '巡查覆盖率（%）', key: 'zhuti',},
          {title: '巡查合格率（%）', key: 'zhuti',},
        ],
        tableData: [],
        data: [{
          value: 'beijing',
