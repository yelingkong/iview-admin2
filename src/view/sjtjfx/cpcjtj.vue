<template>
  <div>
    ...
    <Card title="常州市产品抽检统计" :padding="0" shadow class="qytj_table">
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {title: '未抽检企业数（家）', key: 'zhuti',},
          {title: '抽检1次企业数（家）', key: 'zhuti',},
          {title: '抽检2次及以上企业数（家）', key: 'zhuti',},
          {title: '抽检主体总数（家）', key: 'zhuti',},
          {title: '抽检覆盖率（%）', key: 'zhuti',},
          {title: '抽检合格率（%）', key: 'zhuti',},
        ],
        tableData: [],
        data: [{
          value: 'beijing',
